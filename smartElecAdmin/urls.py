...
urlpatterns = patterns('',
    ...
    # /rl(r'^weather$', 'main.views.datagerator', name='datagerator') , #giving 3 coordinates, 
    ...
    url(r'^user_transactions$', 'main.views.user_transactions',name="userInfo"),    
    url(r'^user_transactionsupdate$', 'main.views.user_transactions_update',name="userInfo"),
